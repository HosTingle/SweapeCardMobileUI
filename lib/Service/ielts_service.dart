...
class IeltsService {
  ...
  Future<List<Word>> getWebsiteData(String selectedLetter) async {
    try {
      final response = await http.get(Uri.parse('http://kelimelog.com/ingilizce-$selectedLetter-harfi-ile-baslayan-ielts-sinav-kelimeleri/'));
        ...
        if (rows != null) {
          for (var row in rows) {
            ...
            if (strongElement != null) {
              ...
              // Türkçe kelimeyi ayırmak için virgül kullanabilirsiniz.
